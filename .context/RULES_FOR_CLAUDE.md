...
<!-- CLAUDE_REVIEW:RULES_FEDERAL_FORMATTING:START -->
<!-- CLAUDE_REVIEW:RULES_FEDERAL_FORMATTING:END -->
...
<!-- CLAUDE_REVIEW:RULES_TOP_THIRD:START -->
<!-- CLAUDE_REVIEW:RULES_TOP_THIRD:END -->
...
<!-- CLAUDE_REVIEW:RULES_SUMMARY_SCOPE:START -->
<!-- CLAUDE_REVIEW:RULES_SUMMARY_SCOPE:END -->
...
<!-- CLAUDE_REVIEW:RULES_BRIDGE_HARD:START -->
<!-- CLAUDE_REVIEW:RULES_BRIDGE_HARD:END -->
...
<!-- CLAUDE_REVIEW:RULES_REVIEW_OUTPUT:START -->
<!-- CLAUDE_REVIEW:RULES_REVIEW_OUTPUT:END -->
