...
### Stage-aware guide selection measurements

Session 2 retained the complete `all` libraries while adding named working subsets. Verified page counts were: Stratix HR 22, hiring manager 44, panel 51, presentation 21, technical 26, final 28, versus `all` 115; Acumatica 23, 44, 50, 21, 27, 29, versus 118; State Farm 23, 41, 50, 20, 23, 28, versus 112. Every named guide was smaller than `all`, and the union of named stages retained every answer, question, story, and evidence sentence from `all` except the intentionally stage-specific instruction line. These measurements are tuning facts, not minimums or acceptance limits. Over-budget stages remain follow-up candidates; do not trim assigned content merely to reach an advisory range.
