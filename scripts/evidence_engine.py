...
CANONICAL_EVIDENCE: tuple[CanonicalEvidence, ...] = (
    ...
    CanonicalEvidence(
        ...
        employer="Aptean",
        role="Customer Success Consultant",
        source_text="Improved renewal and expansion confidence by facilitating 60+ executive workshops and QBRs that aligned implementation roadmaps to business objectives, adoption progress, and measurable outcomes.",
